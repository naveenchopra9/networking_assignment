...
class customTopo(Topo):
    def build(self, **_opts):
        ...
        self.addLink(R1, R2, intfName1='R1-eth1', intfName2='R2-eth1', params1={'ip': '11.0.1.1/24'},
                     params2={'ip': '11.0.1.2/24'})
        self.addLink(R3, R4, intfName1='R3-eth1', intfName2='R4-eth1', params1={'ip': '11.0.2.1/24'},
                     params2={'ip': '11.0.2.2/24'})
        self.addLink(R1, R3, intfName1='R1-eth2', intfName2='R3-eth2', params1={'ip': '11.0.3.1/24'},
                     params2={'ip': '11.0.3.2/24'})
        self.addLink(R2, R4, intfName1='R2-eth2', intfName2='R4-eth2', params1={'ip': '11.0.4.1/24'},
                     params2={'ip': '11.0.4.2/24'})
